...
class ActorModel:
    def __init__(self, num_actions, shape=(84, 84, 4,)):
        self.shape = shape
    ...
    def model(self):
        ...
        common = layers.Dense(512, activation="relu")(layer4)
        action = layers.Dense(self.num_actions, activation="softmax")(common) # linear for negative
