...
from modules.model_actor import ActorModel as Model
...
class ActorCritic:
    ...
    def __init__(self, options={}):
        ...
        self.TC = TensorBoard(log_dir='./tflogs', histogram_freq=0, write_graph=True, write_images=True)
    ...
    def init(self):
        ...
        while True:  # run until solve
            ...
            if self.running_reward > 8000:  # Condition to consider the task solved
